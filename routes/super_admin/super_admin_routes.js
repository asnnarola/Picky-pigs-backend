...
const manage_dish_features_option = require('./manage_dish_features_option');
...
router.use("/manage_dish_features_option", verify.jwtValidation, verify.authorization, manage_dish_features_option);
